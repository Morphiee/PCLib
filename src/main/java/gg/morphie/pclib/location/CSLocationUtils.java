package gg.morphie.pclib.location;

import gg.morphie.pclib.dependencies.QSMethods;
...
public class CSLocationUtils {
    ...
    public static Location findSafeLocationAroundShop(Location shopLocation) {
        ...
        for(Location loc_i : possibleSafeLocList) {
            if (loc_i.getBlock().getType().equals(new QSMethods().getShopSignMaterial())) {
                ...
                if (!isBlockSuffocating(blockAbove)) {
                    ...
                    for (int i = 1; i <= BELOW_SAFE_BLOCK_CHECK_LIMIT; i++) {
                        ...
                        if (blockBelow.getBlock().getType().equals(Material.AIR)
                                ...
                                || blockBelow.getBlock().getType().equals(new QSMethods().getShopSignMaterial())) {
